...
<body class="antialiased">
    <div
        class="relative flex items-top justify-center min-h-screen bg-gray-100 white:bg-gray-900 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div>
                ...
                <p>Sélectionnez un fichier Excel (.xlsx) pour importer les données dans la table
                    "clients".<br><strong>Les
                        colonnes : </strong>name, email, phone, address</p>
